...
<h1> AJOUTER UNE NEWS SUR L'ACCUEIL PERISCOLAIRE </h1>
...
<div class='col-md-8 col-sm-12 col-xs-12 news'>
	...
	<form id="formImage" method="POST" action="index.php?section=traitementAccueilPeriscolaire" enctype="multipart/form-data">   
	...
	<form id="formSansImage" method="POST" action="index.php?section=traitementAccueilPeriscolaire" enctype="multipart/form-data" style="display:none"> 
	    <div class='col-md-12 col-sm-12 col-xs-12'>
	    	<label> Titre : </label><input type=text name='titre' style='width:100%' />
