...
<h1> ADMINISTRATION NEWS PARENTS D'ELEVES </h1>

<div class='col-md-12 col-sm-12 col-xs-12' style='height:20px;'></div>
<div class='col-md-2 col-sm-12 col-xs-12'></div>
<div class='col-md-8 col-sm-12 col-xs-12'>
<a href="index.php?section=adminAjoutNewsParentsEleves" class='btn btn-default buttonCenter' title="ajout">Ajouter une News</a>
</div>
<div class='col-md-2 col-sm-12 col-xs-12'></div>
...
//affichage des News 
	...
	{        
		...
		if($wImage=='vue/images/'){
			echo"
				<form action='index.php?section=traitementmodifnewsparentseleves' method=post>
	...
	<form action='index.php?section=traitementSuppNewsParentsEleves' method=post>
